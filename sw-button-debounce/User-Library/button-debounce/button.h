...
Actual switch    ________| |_| |_|               |_| |_| |___________
                          <----- >                <------>
                             ^----Button glitches----^ 
...
Filter delay used for noice remove
                       _            _          _____   _____
siganl           _____| |__________| |________|     |_|     |________
                 Noise-^------------^----------------^
                       ____         _____      _____      __
Debounce delay   _____|    |_______|     |____|     |____|  |________ NOT OK
signal
                                                  ____________
filtered delay   ________________________________|            |______ OK
signal
